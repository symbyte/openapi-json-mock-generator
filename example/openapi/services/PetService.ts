...
export class PetService {
   ...
   * @throws ApiError
   */
  public static updatePet(requestBody: Pet): CancelablePromise<void> {
   ...
   * @throws ApiError
   */
  public static addPet(requestBody: Pet): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/pet',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getPetById(petId: number): CancelablePromise<Pet> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/pet/{petId}',
      path: {
